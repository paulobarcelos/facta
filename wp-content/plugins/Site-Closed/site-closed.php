...
Description: If you activate this plugin the site will be closed and only logged in logged in users will be able view it normaly. The page will display the content of {theme}/maintenance.php
Version:     1.0
